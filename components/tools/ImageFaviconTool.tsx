...
export default function ImageFaviconTool() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">Convert Image to Favicon</h1>
      ...
      {image && (
        <div className="mb-6">
          <p className="text-sm text-muted-foreground mb-4">Converts image to favicon (16x16, 32x32, 64x64)</p>
