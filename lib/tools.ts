...
export const toolMeta: Record<string, ToolMeta> = {
  ...
  "image-compress": {
    ...
    icon: "🗜️",
    category: CATEGORIES.image,
    seoTitle: "Image Compressor Free — Compress JPG/PNG/WebP Online | Craftisle",
  ...
  "ai-watermark-remover": {
    ...
    category: CATEGORIES.image,
    stars: 4,
    seoTitle: "AI Watermark Remover Free — Remove Gemini/Doubao/Jimeng Watermark Online | Craftisle",
  ...
  "media-downloader": {
    ...
    category: CATEGORIES.image,
    stars: 4,
    seoTitle: "Free Media Downloader — Download Videos from Bilibili, Douyin, TikTok, Instagram | Craftisle",
  ...
  "image-convert": {
    ...
    icon: "🔄",
    category: CATEGORIES.image,
    seoTitle: "Image Converter Free — Convert JPG/PNG/WebP/AVIF Online | Craftisle",
