...
export const toolMeta: Record<string, ToolMeta> = {
  ...
  "ai-watermark-remover": {
    ...
    category: CATEGORIES.image,
    stars: 4,
    seoTitle: "AI Watermark Remover Free — Remove Gemini Watermark Online | Craftisle",
    seoDesc: "Free AI watermark remover online. Remove Gemini AI image watermarks (visible star logo) in browser. 100% client-side, no upload, no signup required.",
    seoKeywords: [
