...
export const toolMeta: Record<string, ToolMeta> = {
  ...
  "aes-des": {
    ...
    stars: 5,
    seoTitle: "AES/DES Encrypt & Decrypt Free — Online Symmetric Encryption",
  ...
  "bcrypt": {
    ...
    category: CATEGORIES.encryption,
    stars: 4,
    seoTitle: "Bcrypt Hash Tool Free — Password Hashing Online",
    ...
    seoKeywords: [
    "bcrypt hash password online free",
    "bcrypt password hashing tool free",
    "bcrypt cost factor online tool",
    "secure password hashing bcrypt free",
    "bcrypt hash generator online",
    "bcrypt verify password online",
    "GPU resistant password hashing free",
    "bcrypt online tool no signup",
    "password hash bcrypt client side",
    "free bcrypt hashing tool online",
    "bcrypt work factor adjustment free",
    "online bcrypt password hash generator"
  ],
  ...
  "hash": {
    ...
    icon: "#️",
    category: CATEGORIES.encryption,
    seoTitle: "Hash Generator Free — MD5/SHA256/SHA512 Online",
  ...
  "json-formatter": {
    ...
    seoTitle: "JSON Formatter & Validator Free Online",
  ...
  "json-minify": {
    ...
    seoTitle: "Minify JSON Free — Online Tool",
  ...
  "json-comparison": {
    ...
    icon: "🔍",
    category: CATEGORIES.json,
    seoTitle: "JSON Compare Free — Online Tool",
  ...
  "json-sort": {
    ...
    icon: "🔤",
    category: CATEGORIES.json,
    seoTitle: "Sort JSON Free — Online Tool",
  ...
  "json-escape": {
    ...
    icon: "✏️",
    category: CATEGORIES.json,
    seoTitle: "Escape JSON Free — Online Tool",
  ...
  "json-stringify": {
    ...
    icon: "📝",
    category: CATEGORIES.json,
    seoTitle: "Stringify JSON Free — Online Tool",
  ...
  "html-formatter": {
    ...
    icon: "🌐",
    category: CATEGORIES.formatter,
    seoTitle: "HTML Formatter Free — Beautify & Minify Online",
    ...
    seoKeywords: [
        ...
        "beautify html online free",
        "html minifier online free",
        "format html code online",
        "html pretty print tool free",
        "indent html online free",
        "html beautifier no signup",
        "minify html online free tool",
        "clean up html code online free",
        "html formatter browser based"
      ],
  ...
  "sql-formatter": {
    ...
    icon: "🗃",
    category: CATEGORIES.formatter,
    seoTitle: "SQL Formatter Free — Beautify & Format SQL Online",
  ...
  "yaml-formatter": {
    ...
    icon: "📑",
    category: CATEGORIES.formatter,
    seoTitle: "YAML Formatter Free — Beautify & Validate YAML Online",
    ...
    seoKeywords: [
        ...
        "beautify yaml online free",
        "yaml to json converter free",
        "json to yaml converter online",
        "yaml syntax checker online free",
        "format yaml file online",
        "yaml linter online free tool",
        "yaml prettifier no signup",
        "yaml formatter browser based"
      ],
  ...
  "html-escape": {
    ...
    icon: "🏷️",
    category: CATEGORIES.formatter,
    seoTitle: "HTML Escape Free — Escape & Unescape HTML Characters",
    seoDesc: "Free HTML escape tool online. Escape or unescape HTML special characters (&lt;, &gt;, &amp;). Prevent XSS attacks. 100% browser-based.",
    seoKeywords: [
        "html escape online free",
        "escape html characters online",
        "html entity encoder free",
        "convert html to entities online",
        "html special characters escape tool",
        "free html escape browser based",
        "html escape no signup free",
        "encode html entities online free",
        "html escape for developers free",
        "escape html tags online free tool"
      ],
  ...
  "base64": {
    ...
    seoKeywords: [
        ...
        "base64 decode online free tool",
        "base64 encoder decoder online",
        "base64 converter free no signup",
        "encode text to base64 online",
        "decode base64 string online free",
        "base64 encode image online free",
        "base64 to text converter free",
        "base64 encoder for developers free",
        "base64 encode file online free tool"
      ],
  ...
  "base32": {
    ...
    icon: "🔤",
    category: CATEGORIES.converter,
    seoTitle: "Base32 Encode/Decode Free — Online Base32 Tool",
  ...
  "base58": {
    ...
    icon: "🔤",
    category: CATEGORIES.converter,
    seoTitle: "Base58 Encode/Decode Free — Bitcoin Base58 Tool",
    ...
    seoKeywords: [
        "base58 encode online free",
        "base58 decode online free tool",
        "base58 encoder decoder online",
        "base58 converter free no signup",
        "bitcoin base58 encode online",
        "base58 to text converter free",
        "base58 checksum encoder online",
        "free base58 tool browser based",
        "base58 vs base64 encoder online",
        "base58 encode string online free"
      ],
  ...
  "radix-converter": {
    ...
    icon: "🔢",
    category: CATEGORIES.converter,
    seoTitle: "Radix Converter Free — Binary/Octal/Decimal/Hex",
  ...
  "csv-json": {
    ...
    icon: "📊",
    category: CATEGORIES.converter,
    seoTitle: "CSV to JSON Converter Free — Online Data Converter",
  ...
  "url-encode": {
    ...
    icon: "🔗",
    category: CATEGORIES.converter,
    seoTitle: "URL Encode/Decode Free — Percent Encoding Online",
    ...
    seoKeywords: [
        ...
        "free URL encode tool browser based",
  ...
  "image-base64": {
    ...
    icon: "🖼️",
    category: CATEGORIES.converter,
    seoTitle: "Image to Base64 Free — Convert Image to Base64 Online",
  ...
  "png-to-svg": {
    ...
    icon: "🖼️",
    category: CATEGORIES.converter,
    seoTitle: "PNG to SVG Converter Free — Raster to Vector Online",
    ...
    seoKeywords: [
        ...
        "convert png to svg free tool",
        "png to svg online free tool",
        "free png to svg converter",
        "png to svg no signup free",
        "online png to svg tool browser based",
        "convert png image to svg online",
        "free online png svg converter",
        "png to svg converter no upload",
        "png to svg tool for developers free"
      ],
  ...
  "ip-radix": {
    ...
    seoTitle: "IP Radix Converter Free — Decimal/Hex/Binary/Octal",
  ...
  "byte-converter": {
    ...
    category: CATEGORIES.converter,
    stars: 4,
    seoTitle: "Byte Converter Free — Online Tool",
  ...
  "sum": {
    ...
    category: CATEGORIES.converter,
    stars: 4,
    seoTitle: "Sum Numbers Free — Online Tool",
  ...
  "cron": {
    ...
    seoTitle: "Cron Expression Builder Free — Online Cron Tester",
  ...
  "regex": {
    ...
    icon: "🔍",
    category: CATEGORIES.dev,
    seoTitle: "Regex Tester Free Online — Test Regular Expressions",
  ...
  "regex-vis": {
    ...
    category: CATEGORIES.dev,
    stars: 5,
    seoTitle: "Regex Visualizer Free — Online AST Graph",
  ...
  "mermaid": {
    ...
    icon: "📈",
    category: CATEGORIES.dev,
    seoTitle: "Mermaid Chart Free — Online Diagram Maker",
  ...
  "svg-editor": {
    ...
    icon: "✏️",
    category: CATEGORIES.dev,
    seoTitle: "SVG Editor Free — Online SVG Code Editor",
    ...
    seoKeywords: [
        ...
        "edit svg file online free",
        "svg viewer and editor online",
        "create svg online free tool",
        "svg path editor online free",
        "change svg color online free",
        "svg optimizer online free",
        "convert svg to png free online",
        "svg code editor browser based",
        "free svg editor no signup"
      ],
  ...
  "qrcode": {
    ...
    seoTitle: "QR Code Generator Free — Custom QR Codes Online",
    ...
    seoKeywords: [
        ...
        "generate qr code from url free",
        "qr code generator with logo free",
        "custom qr code color online free",
        "wifi qr code generator free",
        "vcard qr code generator online",
        "qr code png download free",
        "high resolution qr code generator free",
        "qr code generator browser based"
      ],
  ...
  "random-string": {
    ...
    icon: "🎲",
    category: CATEGORIES.generator,
    seoTitle: "Random String Generator Free — Secure Random Strings",
    ...
    seoKeywords: [
        ...
        "generate random password online free",
        "random alphanumeric string generator",
        "random hex generator online free",
        "random string with custom length online",
        "secure random string generator free",
        "random string no signup free tool",
        "bulk random strings generator online",
        "random id generator online free",
        "random string generator browser based"
      ],
  ...
  "random-group": {
    ...
    icon: "🎲",
    category: CATEGORIES.generator,
    seoTitle: "Random Group Generator Free — Split List Into Groups",
  ...
  "uuid": {
    ...
    seoKeywords: [
        ...
        "uuid v4 generator no signup",
        "guid generator online free tool",
        "bulk uuid generator online free",
        "random uuid generator browser based",
        "uuid v1 v4 v5 generator online",
        "free uuid generator for developers",
        "generate multiple uuids online free",
        "uuid generator with hyphens free"
      ],
  ...
  "image-to-pixel": {
    ...
    icon: "🟧",
    category: CATEGORIES.generator,
    seoTitle: "Pixel Art Generator Free — Convert Image to Pixel Art",
  ...
  "case-converter": {
    ...
    icon: "Aa",
    category: CATEGORIES.text,
    seoTitle: "Case Converter Free — Online Tool",
  ...
  "text-formatter": {
    ...
    icon: "📄",
    category: CATEGORIES.text,
    seoTitle: "Text Formatter Free — Process & Format Text Online",
  ...
  "diff": {
    ...
    icon: "🔄",
    category: CATEGORIES.text,
    seoTitle: "Text Diff Free — Online Categories.Text Tool",
  ...
  "unicode": {
    ...
    icon: "🔣",
    category: CATEGORIES.text,
    seoTitle: "Unicode Tool Free — Online Categories.Text Tool",
  ...
  "string-statistic": {
    ...
    category: CATEGORIES.text,
    stars: 4,
    seoTitle: "Text Statistics Free — Online Tool",
  ...
  "slug-generator": {
    ...
    category: CATEGORIES.text,
    stars: 4,
    seoTitle: "Slug Generator Free — Online Tool",
  ...
  "rot13": {
    ...
    category: CATEGORIES.text,
    stars: 3,
    seoTitle: "ROT13 Cipher Free — Online Tool",
  ...
  "string-randomize-case": {
    ...
    category: CATEGORIES.text,
    stars: 3,
    seoTitle: "Randomize Case Free — Online Tool",
  ...
  "quote": {
    ...
    category: CATEGORIES.text,
    stars: 3,
    seoTitle: "Quote Text Free — Online Tool",
  ...
  "censor": {
    ...
    category: CATEGORIES.text,
    stars: 3,
    seoTitle: "Text Censor Free — Online Tool",
  ...
  "string-rotate": {
    ...
    category: CATEGORIES.text,
    stars: 3,
    seoTitle: "Rotate Text Free — Online Tool",
  ...
  "string-split": {
    ...
    category: CATEGORIES.text,
    stars: 4,
    seoTitle: "Split Text Free — Online Tool",
  ...
  "string-join": {
    ...
    category: CATEGORIES.text,
    stars: 4,
    seoTitle: "Join Lines Free — Online Tool",
  ...
  "string-repeat": {
    ...
    category: CATEGORIES.text,
    stars: 3,
    seoTitle: "Repeat Text Free — Online Tool",
  ...
  "ip-calc": {
    ...
    icon: "🌐",
    category: CATEGORIES.network,
    seoTitle: "IP Calculator Free — Online Tool",
  ...
  "random-port-generator": {
    ...
    category: CATEGORIES.network,
    stars: 4,
    seoTitle: "Random Port Generator Free — Online Tool",
  ...
  "coin-flip": {
    ...
    seoTitle: "Coin Flip Free — Online Categories.Utility Tool",
  ...
  "counter": {
    ...
    icon: "🔢",
    category: CATEGORIES.utility,
    seoTitle: "Counter Free — Online Categories.Utility Tool",
  ...
  "countdown": {
    ...
    icon: "⏳",
    category: CATEGORIES.utility,
    seoTitle: "Countdown Free — Online Categories.Utility Tool",
    ...
    seoKeywords: [
        ...
        "online countdown clock free tool",
        "countdown to date calculator online",
        "event countdown timer free",
        "days until date calculator online",
        "countdown timer no signup free",
        "countdown to birthday online free",
        "countdown timer browser based",
        "how many days until calculator free",
        "countdown timer with sound online free"
      ],
  ...
  "stopwatch": {
    ...
    icon: "⏱️",
    category: CATEGORIES.utility,
    seoTitle: "Stopwatch Free — Online Categories.Utility Tool",
  ...
  "pomodoro": {
    ...
    icon: "🍅",
    category: CATEGORIES.utility,
    seoTitle: "Pomodoro Timer Free — Online Tool",
  ...
  "wheel": {
    ...
    icon: "🎡",
    category: CATEGORIES.utility,
    seoTitle: "Spin Wheel Free — Online Categories.Utility Tool",
  ...
  "scoreboard": {
    ...
    icon: "📊",
    category: CATEGORIES.utility,
    seoTitle: "Scoreboard Free — Online Categories.Utility Tool",
  ...
  "keyboard": {
    ...
    icon: "⌨️",
    category: CATEGORIES.dev,
    seoTitle: "Keyboard Test Free — Online Categories.Dev Tool",
  ...
  "image-crop": {
    ...
    seoKeywords: [
        ...
        "crop photo online free no signup",
        "free image cropping tool browser based",
        "crop jpg png online free",
        "online photo cropper with aspect ratio",
        "crop image to square online free",
        "image crop and resize online free",
        "free online image cutter tool",
        "crop picture online free tool"
      ],
  ...
  "image-change-opacity": {
    ...
    icon: "🔳",
    category: CATEGORIES.image,
    seoTitle: "Change Image Opacity Free — Online Tool",
  ...
  "image-create-transparent": {
    ...
    icon: "🔴",
    category: CATEGORIES.image,
    seoTitle: "Create Transparent PNG Free — Online Tool",
  ...
  "image-split": {
    ...
    icon: "✂️",
    category: CATEGORIES.image,
    seoTitle: "Split Image Free — Online Tool",
  ...
  // ==================== Image: upscale / OCR / editor ====================
  // 三页此前是“幽灵页”：/tools/image-upscale 与 /tools/ai-image-editor 的
  // page.tsx 与 /tools/ocr-text 逐字节相同（md5 e4a4929c…），即 image-upscale
  // 这个 URL 上跑的是 OCR 工具，且三者都不在 toolMeta 里 ⇒ 不进 /tools 目录、
  // 不进 sitemap、没有任何入站内链。现统一交给 app/tools/[tool] 动态段渲染
  // （自带 canonical + JSON-LD + 正文区块 + 相关工具内链）。
  "image-upscale": {
    title: "Image Upscaler",
    desc: "Enlarge images 2x or 4x with AI or instant canvas scaling",
    icon: "🔍",
    category: CATEGORIES.image,
    stars: 5,
    ...
    seoKeywords: [
      ...
      "free photo enlarger no signup",
      "upscale image browser based",
      "make image bigger online free",
      "super resolution image online",
      "upscale anime image free",
      "image resolution enhancer free",
      "2x image upscaler online",
      "enlarge photo for printing",
      "low resolution image fix online",
    ],
    description: "<p>Enlarge a small image to 2x or 4x its original size. <strong>Fast mode</strong> runs entirely on your device with multi-step canvas scaling and an unsharp-mask pass — instant, and it never touches the network. <strong>AI modes</strong> run a Swin2SR super-resolution network inside your browser to reconstruct plausible detail instead of just averaging neighbouring pixels, which is what you want for a low-resolution photo or a screenshot that has to be printed.</p><p>The two modes do different jobs. Canvas scaling is right for screenshots, icons, charts and flat-colour graphics, where edges stay crisp and invented detail would only make things worse. The AI model is right for photographs, scanned artwork and images that were heavily downsized, where texture can genuinely be recovered. Nothing is uploaded in either mode — the only network request is the one-time model download.</p>",
    howToUse: [
      { heading: "Upload your image", text: "Drag in a JPG, PNG or WebP, or click to browse. The original pixel dimensions are shown straight away." },
      { heading: "Pick an upscale factor", text: "2x is fast and safe for most images; 4x is meant for small sources. The projected output size is displayed before you start." },
      { heading: "Choose a quality mode", text: "Fast (no download) for screenshots and graphics, Photo (AI 4x) for real photographs, Artwork (AI 2x) for line art and illustrations." },
      { heading: "Compare and download", text: "The original and the result are shown side by side. Download the PNG and keep the original as a fallback." },
    ],
    useCases: [
      { title: "Printing a small photo", text: "A 500 px image prints soft at any real size. Upscaling it to 2000 px gives it enough pixels to look acceptable on paper." },
      { title: "Rescuing an old or low-res scan", text: "Scanned photos and exports from old software are usually far below modern screen resolutions. AI upscaling recovers more usable texture than plain resizing." },
      { title: "Preparing assets for a retina display", text: "A 1x asset looks blurry on a 2x screen. Upscaling the source is often faster than tracking down or re-exporting the original." },
    ],
    faq: [
      { q: "Is upscaling the same as increasing resolution?", a: "No. Resolution is a pixel count; upscaling is the operation that increases it. Pixels are invented either way — interpolation averages neighbours, while the AI model predicts what plausible detail would look like. That is why AI output looks sharper on photos and can look worse on flat graphics with hard edges." },
      { q: "Can I really enlarge an image without losing quality?", a: "You cannot create detail that was never captured. What upscaling avoids is the muddy, smeared look of naive stretching: edges stay defined and texture looks plausible. For a genuinely detailed large print, a higher-resolution original is always better." },
      { q: "Should I use AI mode or fast mode?", a: "Use AI mode for photographs, scans and heavily compressed images. Use fast mode for screenshots, icons, UI mockups, charts and flat-colour illustrations — those have no real texture to recover, and the canvas path is instant with nothing to download." },
  ...
  "ocr-text": {
    ...
    category: CATEGORIES.image,
    stars: 5,
    seoTitle: "Free OCR Online — Extract Text from Images & Screenshots",
    seoDesc: "Free OCR online. Extract text from images, screenshots and scanned pages in your browser. 100+ languages, no upload, no account, no watermark.",
    seoKeywords: [
      "ocr online free",
      ...
      "screenshot to text",
      "free ocr no signup",
      "ocr browser based no upload",
      "jpg to text converter online",
      "scanned document to text",
      "photo to text free",
      "online ocr 100 languages",
      "extract text from screenshot free",
      "no upload ocr tool",
      "free ocr software online",
      "convert image to editable text",
    ],
    description: "<p>Turn a screenshot, a photographed page or a scanned document into selectable, copyable text. Recognition runs in your browser, so the image is never uploaded — which matters when the page you are transcribing is a contract, an invoice or an identity document that should not be emailed to an unknown service.</p><p>OCR is not magic: accuracy depends on resolution, contrast, and how much the page is rotated or skewed. A clean 300 dpi scan is near-perfect. A photo taken at an angle in poor light will need correction, and handwriting remains unreliable in every OCR tool on the market. Proofread numbers and names against the original before you rely on the output.</p>",
    howToUse: [
      { heading: "Upload an image", text: "Drop in a JPG, PNG, WebP or a screenshot. Straight-on, higher-resolution images produce noticeably better results." },
      { heading: "Choose the language", text: "Select the language of the text in the image. Choosing the wrong language is the single most common cause of garbled output." },
      { heading: "Run the extraction", text: "Recognition runs on your device and returns the text with progress shown as it works." },
      { heading: "Copy or download", text: "Copy the text straight to your clipboard, or download it as a plain .txt file." },
    ],
    useCases: [
      { title: "Digitising a printed document", text: "Get a page of a printed contract, invoice or report into an editor without retyping it line by line." },
      { title: "Copying text out of a screenshot", text: "Error messages, code and tables inside screenshots are not selectable. OCR turns them into text you can search, paste and diff." },
      { title: "Translating a photo of text", text: "Extract the text first and translate the result — that gives far better output than trying to translate the image itself." },
    ],
    faq: [
      { q: "How accurate is free online OCR?", a: "High for clean print, screenshots and 300 dpi scans. Noticeably lower for handwriting, stylised fonts, low light, angled shots, and dense tables with rules and borders. Always proofread numbers and proper nouns against the source." },
      { q: "Is my image uploaded to a server?", a: "No. Recognition happens on your device, so the image never reaches a server. That is a deliberate design choice: the documents people most often need to OCR — IDs, invoices, contracts — are exactly the ones they should not be handing to an unknown third party." },
      { q: "What image quality do I need?", a: "Around 300 dpi equivalent: straight, evenly lit, and filling most of the frame. Crop away the desk around the page first — stray background is a common cause of spurious characters creeping into the output." },
      { q: "Can it read handwriting?", a: "Poorly and unpredictably. Even paid OCR services struggle with running handwriting, and there is no free tool that solves it. Handwritten notes are still the one category where retyping is usually faster." },
      { q: "Is it free, and do I need an account?", a: "It is free, with no account, no page limit and no watermark. Because your own device does the work, there is no per-page server cost to charge for." },
      { q: "Can it read text from a PDF?", a: "Export the PDF pages as images first, then run them through this tool. A PDF that already contains a text layer does not need OCR at all — you can copy from it directly." },
    ],
    relatedTools: ["image-upscale", "text-translator", "image-convert", "image-compress"],
  },

  "ai-image-editor": {
    title: "AI Image Editor",
    desc: "Edit photos and remove backgrounds in the browser",
    icon: "🎨",
    category: CATEGORIES.image,
    stars: 5,
    seoTitle: "AI Image Editor Free — Edit Photos & Remove Backgrounds Online",
    seoDesc: "Free AI image editor online. Remove backgrounds, then adjust brightness, contrast, saturation and filters in your browser. No upload, no signup.",
    seoKeywords: [
      "ai image editor free",
      "online photo editor no signup",
      "remove background free online",
      "image editor browser based",
      "free photo retouching online",
      "adjust brightness contrast online",
      "background remover free no watermark",
      "edit photo without uploading",
      "free image editing tool online",
      "ai photo editor online free",
      "change exposure saturation online",
      "blur background photo online",
      "rotate and crop image free",
    ],
    description: "<p>An editor for the jobs people actually open a photo editor to do: cut the subject out of its background, then fix exposure, contrast, saturation, blur and orientation until it looks right. Every operation runs on your device, so there is no upload, no size limit, no queue and no account required.</p><p>The adjustment sliders and filters are plain canvas operations, which is why they are instant and non-destructive: move a value, see the result, change your mind. Background removal uses a segmentation model that runs locally, so it keeps working after the first load even without a connection.</p>",
    howToUse: [
      { heading: "Open an image", text: "Drop in a JPG, PNG or WebP. Nothing is uploaded — the file is read directly from your device." },
      { heading: "Adjust the basics", text: "Use the sliders for brightness, contrast, saturation and exposure. The preview updates live as you drag." },
      { heading: "Remove the background or apply a filter", text: "Segmentation runs locally and can replace the background with a solid colour; filters and blur apply on top of your adjustments." },
      { heading: "Export the result", text: "Download as PNG when you need transparency, or JPG/WebP for a smaller file." },
    ],
    useCases: [
      { title: "Clean product photos", text: "Cut a product out of a cluttered background and drop it on a plain one for a listing or catalogue." },
      { title: "Profile pictures and ID photos", text: "Replace a busy background with a solid colour, then crop to a standard portrait size." },
      { title: "Rescuing an underexposed photo", text: "Lift an image that came out too dark or too washed out without installing desktop software." },
    ],
    faq: [
      { q: "Is this image editor really free?", a: "Yes — no account, no watermark and no charge for exporting. The processing cost lands on your own device, so there is no per-image cost to pass on to you." },
      { q: "Do I have to upload my photo?", a: "No. The file is opened and edited in the browser. That matters for ID photos, documents and pictures of other people, which is why this editor is built local-first rather than cloud-first." },
      { q: "Will background removal be perfect?", a: "Not always. Clean edges against a contrasting background come out well. Hair, fur, glass, transparent objects and motion blur are intrinsically hard for any segmentation model, free or paid, and usually need a manual touch-up." },
      { q: "What formats can I export?", a: "PNG when you need transparency after removing a background, and JPG or WebP when you want a smaller file. Converting to WebP is usually the biggest saving." },
      { q: "Does it work on a phone?", a: "Yes, in any modern mobile browser. The sliders are simply easier to control accurately on a larger screen." },
      { q: "Does it lower the image quality?", a: "Adjustments are applied to the full-resolution pixels, not a preview, so exported files keep the original dimensions. Re-encoding to JPG is lossy — export PNG when quality matters more than size." },
    ],
    relatedTools: ["image-color-adjust", "image-crop", "ai-watermark-remover", "id-photo"],
  },

  "video-compress": {
    title: "Video Compressor",
    desc: "Shrink MP4, MOV, WebM and MKV videos in the browser",
    icon: "🎬",
    category: CATEGORIES.converter,
    stars: 5,
    seoTitle: "Video Compressor Free — Compress MP4, MOV & WebM Online",
    seoDesc: "Free video compressor online. Shrink MP4, MOV, WebM and MKV files in your browser. No upload, no watermark, no server-side file size limit.",
    seoKeywords: [
      "compress video online free",
      "video compressor no upload",
      "reduce video file size",
      "mp4 compressor free online",
      "compress video for whatsapp",
      "reduce video size for email",
      "free video compressor no watermark",
      "compress mov to mp4 online",
      "shrink video file size browser",
      "video compressor no signup",
      "compress video without uploading",
      "reduce 4k video size online",
      "compress screen recording free",
    ],
    description: "<p>Shrink a video before you send, upload or archive it. Re-encoding happens on your device using the browser's native WebCodecs encoders, so unlike most online compressors the file is never uploaded — no 100 MB cap, no waiting in a server queue, and no copy of your video left on someone else's disk.</p><p>How much you save depends entirely on what you feed it. A 4K phone clip capped at 720p typically shrinks to a fraction of its size. A video that was already compressed hard — a 15 MB one-minute MP4 from a social platform — will barely move, because the data was squeezed once already. No tool can honestly promise more than that, so this one tells you when the re-encode came out larger instead of handing you a worse file quietly.</p>",
    howToUse: [
      { heading: "Upload a video", text: "Drop in an MP4, MOV, WebM, MKV or AVI file. It is read directly from your device and stays there." },
      { heading: "Pick a compression level", text: "Smallest file caps the long edge at 1280 px, Balanced at 1920 px, and Best quality keeps the original resolution." },
      { heading: "Choose the output format", text: "MP4 (H.264) plays almost everywhere; WebM (VP9) is usually smaller but less compatible with older editors." },
      { heading: "Preview and download", text: "Play the result in the page before saving it. If the file got bigger, keep the original — the tool will say so." },
    ],
    useCases: [
      { title: "Email and messaging limits", text: "Attachments are usually capped at 10-25 MB. Compressing is the difference between sending the clip and sending a link." },
      { title: "Freeing up phone storage", text: "Screen recordings and long clips are both the biggest files people keep and the ones that compress best." },
      { title: "Fitting a platform's upload cap", text: "Re-encode down to the limit locally rather than letting the platform crush the quality for you with unknown settings." },
    ],
    faq: [
      { q: "Why is my compressed video bigger than the original?", a: "Because it was already efficiently encoded. Re-encoding a previously compressed file adds container and encoder overhead while losing quality, so it can grow. Use the Smallest file preset, or keep the original — this tool warns you when that happens instead of quietly returning a worse file." },
      { q: "Is there a file size limit?", a: "Only your device's memory. Because nothing is uploaded there is no server-side cap, but files well over 500 MB can exhaust memory in a browser tab, so shorter clips are safer." },
      { q: "Is my video uploaded to a server?", a: "No. Both demuxing and encoding happen inside the page using WebCodecs. You can verify it yourself: open the browser network panel and you will see no upload of your file." },
      { q: "Which browsers are supported?", a: "Anything with WebCodecs: Chrome and Edge 94+, Safari 16.4+, Firefox 130+. On older browsers the encoder is unavailable and the page will tell you rather than failing silently." },
      { q: "Does compressing reduce quality?", a: "Lossy compression always does. The aim is to remove what viewers will not notice — excess resolution, excess bitrate, excess audio quality. Start with Balanced and only go lower if the file is still too large." },
      { q: "How long does it take?", a: "Roughly real-time or faster on a modern machine, and it scales with resolution rather than file size. A 60-second 1080p clip usually finishes in under a minute, and you can watch progress throughout." },
    ],
    relatedTools: ["media-downloader", "image-compress", "image-convert", "pdf-tools"],
  },

  // ==================== 2026-09-22 接线：仓库里已写好但从未挂上的组件 ====================
  // 背景：这 7 个组件（AsciiArtTool/BarcodeTool/ColorPickerTool/JsonValidatorTool/
  // CsvToTsvTool/ChangeCsvSeparatorTool/MarkdownTool）一直躺在 components/tools/ 里，
  // 既没进 componentLoaders、也没被任何静态页 import ⇒ 用户永远看不到。
  // 另有 7 个同名组件（ReverseTool/SortTool/…）是 List* 系列的旧版重复实现、1 个坏桩
  // （CreateGifTool 内容竟是找重复图片）、1 个需 props 的子组件（image-compare）、
  // 1 个与 unix-to-date 重复的 TimestampTool —— 这些**故意不接**，接上就是重复内容页。
  // 校验脚本：`pnpm audit:pages`。
  "ascii-art": {
    title: "ASCII Art Generator",
    desc: "Turn text into ASCII art banners with 6 fonts",
    icon: "🔤",
    category: CATEGORIES.generator,
    seoTitle: "ASCII Art Generator Free — Text to ASCII Banner Online",
    seoDesc: "Free ASCII art generator online. Turn text into ASCII banners with 6 fonts — Standard, Ghost, Slant, Bubble, Banner and Big. Copy or download.",
    seoKeywords: [
      "ascii art generator online free",
      "text to ascii art",
      "ascii banner generator",
      "figlet online",
      "ascii text generator free",
      "convert text to ascii",
      "ascii font generator",
      "big text generator ascii",
      "ascii art maker no signup",
      "bubble text generator ascii",
      "ascii art for readme",
      "terminal banner text generator",
    ],
    description: "<p>Convert a word or a short phrase into a block of ASCII art you can paste anywhere plain text is allowed — a README, a terminal banner, a code comment header, a chat message. Six FIGlet fonts ship with it (Standard, Ghost, Slant, Bubble, Banner and Big), and the result updates as you type, so you can try a word against every font in a few seconds.</p><p>ASCII art is a deliberately low-tech format: it needs no image hosting, no fonts to install, and no renderer. That is exactly why it still turns up in places where images will not: <em>README</em> headers, MOTD banners on servers, build logs, and old-school signature blocks. Keep the input short — a single word or two lines works; long sentences wrap into an unreadable mess in most fonts.</p>",
    howToUse: [
      { heading: "Type your text", text: "Enter a word or short phrase. One or two words gives the cleanest result in most fonts." },
      { heading: "Pick a font", text: "Switch between Standard, Ghost, Slant, Bubble, Banner and Big. The preview regenerates instantly." },
      { heading: "Copy the output", text: "Copy the ASCII art to your clipboard and paste it wherever you need it." },
      { heading: "Keep it narrow", text: "Most fonts are designed around roughly 80 characters of width — shorter input stays legible when pasted." },
    ],
    useCases: [
      { title: "README and doc headers", text: "Give a repository or an internal document a header that renders identically in every Markdown viewer and terminal." },
      { title: "Terminal banners", text: "Drop a project name into a shell startup script or a login MOTD, where an image cannot be displayed." },
      { title: "Code comment blocks", text: "Mark the start of a major section in a long source file so it is findable when scrolling quickly." },
    ],
    faq: [
      { q: "What is ASCII art actually used for?", a: "Anywhere plain text is the only format available: README headers, server MOTD banners, build-log separators, comment blocks, and chat or forum posts that do not accept images." },
      { q: "Why does long text look wrong?", a: "Each character maps to a block of letters, so width multiplies fast. A 60-character sentence in Big becomes hundreds of columns wide and wraps unpredictably. Keep input to a word or two." },
      { q: "Is the output editable?", a: "Yes — it is plain text made of ordinary characters. You can trim, align or recolour it in any editor, unlike a screenshot of stylised text." },
      { q: "Does it work with non-Latin characters?", a: "Mostly not. FIGlet fonts are built from a fixed ASCII character set, so accented letters and CJK input generally render as blanks or fall back to a default glyph." },
      { q: "Is my text sent anywhere?", a: "No. The font rendering runs in your browser and the text never leaves your device." },
    ],
    relatedTools: ["barcode", "qrcode", "text-formatter", "random-string"],
  },

  "barcode": {
    title: "Barcode Generator",
    desc: "Generate CODE128, EAN-13 and UPC-A barcodes as SVG or PNG",
    icon: "|||",
    category: CATEGORIES.generator,
    seoTitle: "Barcode Generator Free — Create CODE128, EAN-13 & UPC-A Online",
    seoDesc: "Free barcode generator online. Create CODE128, EAN-13, UPC-A and more as SVG or PNG, with adjustable width, height and text. No signup.",
    seoKeywords: [
      ...
      "generate barcode from number online",
      "barcode image download free",
      "code39 barcode generator",
      "itf-14 barcode generator",
    ],
    description: "<p>Generate a barcode from any number or string and download it as SVG or PNG. Pick the symbology that matches what will scan it — CODE128 for general alphanumeric data, EAN-13 and UPC-A for retail products, CODE39 and ITF-14 for logistics and cartons — and set the bar width, height and whether the human-readable value is printed underneath.</p><p>The two output formats have different jobs. <strong>SVG</strong> is vector: it stays razor-sharp at any print size, so it is the right choice for a label that will be physically printed. <strong>PNG</strong> is easier to drop into software that does not accept vectors. Either way the barcode is drawn in your browser from the data you typed — nothing is uploaded, and there is no watermark or registration.</p>",
    howToUse: [
      { heading: "Enter the value", text: "Type the number or text to encode. Retail formats such as EAN-13 require an exact digit count." },
      { heading: "Choose the symbology", text: "CODE128 handles most alphanumeric data; use EAN-13 or UPC-A for products that will be scanned at a till." },
      { heading: "Adjust size and text", text: "Set bar width, bar height and whether the value is shown underneath. Wider bars survive cheaper scanners and rougher printing." },
      { heading: "Download SVG or PNG", text: "Use SVG for anything that will be printed, PNG when the target software needs a raster image." },
    ],
    useCases: [
      { title: "Product labels", text: "Generate an EAN-13 or UPC-A code for a retail item and drop the SVG straight into a label layout." },
      { title: "Inventory and asset tags", text: "Encode serial numbers as CODE128 for warehouse scanners and equipment labels." },
      { title: "Shipping cartons", text: "ITF-14 is the standard for corrugated outer cases where a smaller code would not survive handling." },
    ],
    faq: [
      { q: "Which barcode format should I use?", a: "CODE128 for general data such as serial numbers and internal codes. EAN-13 or UPC-A for retail products — those formats carry a fixed number of digits and include a check digit. CODE39 for legacy industrial systems, ITF-14 for shipping cartons." },
      { q: "Why does my EAN-13 code say it is invalid?", a: "EAN-13 takes exactly 12 digits plus a check digit, and UPC-A takes exactly 11 plus a check digit. Too few or too many digits is the usual cause. Use CODE128 if your value is not a pure retail number." },
      { q: "Will it scan when printed?", a: "Print at 100% scale without resizing the image afterwards. Bars that are scaled down by a word processor or squeezed by a label printer are the most common reason a correct barcode will not scan." },
      { q: "What bar width should I pick?", a: "For normal laser or phone scanners, 2 px is a good default. Increase it for small labels, low-resolution printers, or codes that will be scanned from a distance." },
      { q: "Is there a watermark or limit?", a: "No watermark, no account and no limit on how many codes you generate — the drawing happens in your browser, so there is no server cost to meter." },
      { q: "Is my data uploaded?", a: "No. The barcode is rendered locally and the value never leaves your device, which matters when the numbers are internal product or asset IDs." },
    ],
    relatedTools: ["qrcode", "ascii-art", "color-picker", "random-string"],
  },

  "color-picker": {
    title: "Color Picker",
    desc: "Pick a color and copy it as HEX, RGB or HSL",
    icon: "🎨",
    category: CATEGORIES.utility,
    seoTitle: "Color Picker Online Free — HEX, RGB & HSL Converter",
    seoDesc: "Free color picker online. Pick any color and copy it as HEX, RGB or HSL instantly, plus a random color generator. No upload, no signup.",
    seoKeywords: [
      ...
      "color code picker free",
      "pick color and copy hex",
      "html color picker online",
      "color converter hex rgb hsl",
      "eyedropper tool online free",
    ],
    description: "<p>Choose a color and get its code in the three formats you actually paste into code: HEX for CSS and design tools, RGB for canvas work and legacy properties, and HSL when you need to reason about lightness and saturation rather than raw channels. All three update live as you move the picker, and each is one click from your clipboard.</p><p>The converter runs in both directions — type or paste a value you already have and read off the other two representations. HEX and RGB are the same numbers in different bases; HSL is the one that maps to how people describe colour, which is why it is the format to reach for when you need \"the same blue, but lighter\" rather than a new hex value guessed by eye.</p>",
    howToUse: [
      { heading: "Pick a color", text: "Use the picker or type a HEX value directly. All three notations update instantly." },
      { heading: "Read every format", text: "HEX, RGB and HSL are shown side by side, so you can copy the one your codebase uses." },
      { heading: "Copy with one click", text: "Each value has its own copy button and confirms what was copied." },
      { heading: "Generate a random color", text: "Use the refresh button when you need a starting point and only care that it is different." },
    ],
    useCases: [
      { title: "Matching a brand color", text: "Convert the hex from a brand guide into RGB or HSL for a target that expects those formats." },
      { title: "Building a palette", text: "Generate random colors as a starting point, then adjust lightness in HSL to build a consistent scale." },
      { title: "Reading a color off a value", text: "Paste a hex you found in a stylesheet to see what it actually looks like before using it." },
    ],
    faq: [
      { q: "What is the difference between HEX, RGB and HSL?", a: "They describe the same color in different ways. HEX and RGB are raw channel values in different bases. HSL describes hue, saturation and lightness, which matches how people talk about color — that is what you want when adjusting rather than specifying." },
      { q: "Why is my converted HSL slightly off?", a: "HSL is a lossy round-trip through integer rounding. Converting hex to HSL and back can shift a channel by one, which is invisible on screen but will not be byte-identical in a diff." },
      { q: "Can I pick a color from an image or the screen?", a: "Not in this tool — browser tabs cannot read pixels outside their own document. Use your operating system's eyedropper for that, then paste the value here to convert it." },
      { q: "What does the 8-digit hex with an extra pair mean?", a: "The last two digits are the alpha channel — opacity. This picker outputs opaque 6-digit hex; add alpha manually or use rgba() when you need transparency." },
      { q: "Is anything sent to a server?", a: "No. The conversion is arithmetic done in your browser, and nothing is stored or transmitted." },
    ],
    relatedTools: ["image-color-palette", "image-color-adjust", "barcode", "qrcode"],
  },

  "json-validator": {
    title: "JSON Validator",
    desc: "Validate JSON syntax and inspect its structure",
    icon: "✅",
    category: CATEGORIES.json,
    seoTitle: "JSON Validator Free — Check JSON Syntax & Find Errors Online",
    seoDesc: "Free JSON validator online. Check JSON syntax, see the exact parse error, and inspect type, size and keys. Runs in your browser, nothing uploaded.",
    seoKeywords: [
      "json validator online free",
      "json syntax checker",
      ...
      "json error finder",
      "check json validity",
      "json lint online free",
      "json parser online",
      "json format check no upload",
      "find error in json file",
      "json structure inspector",
    ],
    description: "<p>Paste a JSON document and find out immediately whether it parses — and if it does not, what the parser objected to and where. Alongside the verdict you get the structural facts that are tedious to count by hand: the root type, the serialised size, the number of top-level keys or array items, and the key names themselves for small objects.</p><p>The validation runs against the browser's own JSON parser, which is the same strict grammar every JSON tool follows — no trailing commas, no comments, no single-quoted strings, and every key must be double-quoted. That strictness is the point: a file that this accepts will load in your application, and a file it rejects will fail there too. Since the document is parsed locally, pasting a config with credentials or tokens in it does not send those values anywhere.</p>",
    howToUse: [
      { heading: "Paste your JSON", text: "Paste the document, or a fragment you are unsure about. Nothing is uploaded — it is parsed in the page." },
      { heading: "Validate", text: "The result tells you whether it parses, and if not, the parser's error message with the offending position." },
      { heading: "Inspect the structure", text: "For valid input you also get the root type, size in characters, and key or item counts." },
      { heading: "Fix and re-check", text: "Edit the input and validate again. Most failures are a trailing comma, an unquoted key, or a single-quoted string." },
    ],
    useCases: [
      { title: "Debugging a config file", text: "A settings file that will not load usually has a syntax error one line before the reported position — validate to find it without restarting the app." },
      { title: "Checking API responses", text: "Confirm that a payload is valid JSON before blaming the endpoint for a parse failure in your client code." },
      { title: "Reviewing a hand-edited data file", text: "Trailing commas are the most common way a carefully edited JSON file breaks. One paste catches them all." },
    ],
    faq: [
      { q: "Why is my JSON invalid when it looks fine?", a: "The usual causes, in order of frequency: a trailing comma after the last item, a key without double quotes, a single-quoted string, a comment (JSON has none), or a missing brace. The reported position often points just past the real problem, so check the line before it too." },
      { q: "Does it validate against a JSON Schema?", a: "No. This checks that the document is syntactically valid JSON, which is a different question from whether it matches an expected shape. Syntax first: a file that fails here will fail in every consumer." },
      { q: "Is there a size limit?", a: "Only your browser's memory. Validation is done by the native parser, which is fast, but pasting a multi-megabyte document into a text box is limited by the browser rather than the tool." },
      { q: "Is my JSON uploaded?", a: "No. It is parsed in the page, so nothing is transmitted. That matters when validating a config containing API keys, tokens or connection strings." },
      { q: "How is this different from a JSON formatter?", a: "They answer different questions. This tool tells you whether the document is valid and describes its shape; the formatter pretty-prints an already-valid document so you can read it." },
    ],
    relatedTools: ["json-formatter", "sort-json", "json-comparison", "csv-json"],
  },

  "csv-to-tsv": {
    title: "CSV to TSV Converter",
    desc: "Convert comma-separated data to tab-separated values",
    icon: "⇥",
    category: CATEGORIES.converter,
    seoTitle: "CSV to TSV Converter Free — Convert Comma to Tab Separated Online",
    seoDesc: "Free CSV to TSV converter online. Convert comma-separated data to tab-separated values with quoted-field support. Browser-based, no upload.",
    seoKeywords: [
      "csv to tsv converter",
      "convert csv to tab separated",
      "csv to tsv online free",
      "comma to tab delimiter converter",
      "tsv converter online",
      "csv delimiter converter free",
      "convert csv for spreadsheet paste",
      "csv to tabs online",
      "tab separated values converter",
      "csv to tsv no upload",
    ],
    description: "<p>Convert comma-separated data into tab-separated data. TSV is the more robust format of the two: commas appear inside real-world values constantly — addresses, names, amounts — while literal tab characters essentially never do, so a TSV file needs far less quoting and survives a round trip through a spreadsheet with fewer surprises.</p><p>The parser is quote-aware rather than splitting on every comma it sees. A field like <code>\"Smith, John\"</code> stays one field and comes out with the surrounding quotes removed, which is what makes a naive comma-split produce extra columns. Line endings are normalised too, so a file exported from Windows and one from macOS behave identically. Conversion happens in the page — nothing is uploaded.</p>",
    howToUse: [
      { heading: "Paste your CSV", text: "Paste the comma-separated rows. The header row, if any, is treated like any other row." },
      { heading: "Convert", text: "Each row is split on commas with quoted fields respected, then joined with tab characters." },
      { heading: "Copy the result", text: "Copy the TSV output and paste it directly into a spreadsheet, which splits it into columns automatically." },
      { heading: "Check quoted fields", text: "Fields wrapped in double quotes survive intact even when they contain a comma — that is the case a plain search-and-replace gets wrong." },
    ],
    useCases: [
      { title: "Pasting into a spreadsheet", text: "Paste TSV into Excel or Google Sheets and it lands in columns with no import dialog and no delimiter question." },
      { title: "Fixing a mangled export", text: "When a CSV with quoted commas imported as too many columns, converting to TSV first is usually the quickest repair." },
      { title: "Preparing data for a database load", text: "Many bulk loaders default to tab-delimited input because it avoids most quoting ambiguity." },
    ],
    faq: [
      { q: "Why convert CSV to TSV at all?", a: "Tabs are far less likely than commas to appear inside real data, so TSV needs quoting much less often and is less prone to being mis-split on the next import. It is a pragmatic robustness choice, not a format upgrade." },
      { q: "What happens to quoted fields?", a: "A field wrapped in double quotes is kept as one field, the quotes are stripped, and `\"\"` inside it becomes a literal quote — the RFC 4180 convention. This is the specific case a naive comma split gets wrong." },
      { q: "Why is my output missing blank lines?", a: "Rows that are empty or only whitespace are dropped, since they are almost always artefacts of a trailing newline or a copy-paste. If blank rows are meaningful data, remove them after conversion instead." },
      { q: "Can it handle a different delimiter on the way in?", a: "This tool converts from comma specifically. For semicolon, pipe or arbitrary delimiters use the CSV separator converter instead." },
      { q: "Is my data uploaded?", a: "No. The conversion runs in the page, so the file never reaches a server — relevant for exports containing customer records or financial data." },
    ],
    relatedTools: ["change-csv-separator", "csv-to-json", "tsv-to-json", "csv-json"],
  },

  "change-csv-separator": {
    title: "Change CSV Separator",
    desc: "Switch between comma, semicolon, tab and pipe delimiters",
    icon: "⇄",
    category: CATEGORIES.converter,
    seoTitle: "CSV Separator Converter Free — Change Delimiter to Semicolon, Tab or Pipe",
    seoDesc: "Free CSV separator converter online. Switch between comma, semicolon, tab and pipe delimiters instantly, with quoted fields preserved. No upload.",
    seoKeywords: [
      "change csv separator online",
      "csv delimiter converter",
      "comma to semicolon csv converter",
      "semicolon delimited to comma",
      "pipe delimited converter",
      "change csv delimiter free",
      "csv to semicolon online",
      "convert tab delimited to comma",
      "csv separator changer no upload",
      "european csv semicolon to comma",
    ],
    description: "<p>Change the delimiter in a delimited text file: comma to semicolon, semicolon to comma, tab to pipe, or any other combination of the four common separators. This is the fix for the single most common spreadsheet annoyance — a file that opens with every row crammed into one column, because it was written with a delimiter your locale does not expect.</p><p>European Excel is the usual culprit: it writes semicolons as the field separator because the comma is already the decimal separator in those locales, so the same export that opens correctly in one country lands in one column in another. Switching the delimiter makes the file importable again without changing any of the data. Quoted fields are respected, both before and after the change, and the work is done in your browser.</p>",
    howToUse: [
      { heading: "Paste the file contents", text: "Paste the delimited text. Copy straight from the file or open it in a text editor first." },
      { heading: "Choose the current delimiter", text: "Set the input delimiter to whatever the file actually uses — comma, semicolon, tab or pipe." },
      { heading: "Choose the target delimiter", text: "Pick what the destination program expects. Excel in a European locale usually wants a semicolon." },
      { heading: "Copy the result", text: "Copy the converted text back into your file or paste it directly into the target program." },
    ],
    useCases: [
      { title: "Opening a European CSV in US Excel", text: "A semicolon-delimited export from a European system opens as one column in a US locale. Convert to comma first." },
      { title: "Feeding a strict importer", text: "Some bulk-import tools accept only one delimiter. Convert rather than reformatting the data by hand." },
      { title: "Preparing pipe-delimited data", text: "Convert to the pipe-delimited format some ETL pipelines and legacy systems expect." },
    ],
    faq: [
      { q: "Why does my CSV open in a single column?", a: "The file uses a delimiter your spreadsheet is not expecting. The classic case is a semicolon-delimited export from a European locale opened in a US locale, where the comma is both the field separator and (elsewhere) a decimal point. Change the delimiter here and it imports correctly." },
      { q: "Which delimiter should I convert to?", a: "Match what the destination expects. Excel in most European locales wants a semicolon; most US tools and database loaders expect a comma; tab is the safest for pasting into a spreadsheet without an import dialog." },
      { q: "Are quoted fields handled?", a: "Yes, on both sides. A quoted field containing the original delimiter stays one field, and quotes are re-applied on output only when a field would otherwise be ambiguous." },
      { q: "Are the spaces around fields trimmed?", a: "No — field contents are preserved as-is. Only the surrounding double quotes are removed where they were purely structural, so values are not silently altered." },
      { q: "Is my data sent to a server?", a: "No. Everything happens in the page, which matters for exports containing customer names, addresses or payment references." },
    ],
    relatedTools: ["csv-to-tsv", "csv-to-json", "insert-csv-column", "swap-csv-columns"],
  },

  "markdown": {
    title: "Markdown Editor",
    desc: "Write Markdown with live preview and GFM support",
    icon: "📄",
    category: CATEGORIES.text,
    seoTitle: "Markdown Editor Online Free — Live Preview & GFM Support",
    seoDesc: "Free online Markdown editor with live preview. Write GFM tables, task lists and code blocks, then copy the source or download as .md. No signup.",
    seoKeywords: [
      ...
      "markdown to readme editor",
      "online markdown editor no signup",
      "github flavored markdown editor",
      "markdown table generator online",
      "edit md file in browser",
    ],
    description: "<p>A Markdown editor with a live preview beside it, so you see the rendered result as you type rather than after a commit or a push. It supports GitHub Flavored Markdown — tables, task lists, strikethrough, fenced code blocks — which is the dialect almost every README, issue and wiki actually uses, and the one most basic previewers leave out.</p><p>The source pane is a real code editor with Markdown syntax highlighting, so headings, links and code fences are visually distinct while you write. When you are done, copy the source for a pull request or download it as a <code>.md</code> file. Everything is local: your document is never uploaded, which is the reason to prefer this over a web editor that stores your drafts on someone else's server.</p>",
    howToUse: [
      { heading: "Start typing", text: "Write Markdown in the source pane. A sample document loads first so you can see the supported syntax." },
      { heading: "Watch the preview", text: "The rendered output updates as you type, including tables, task lists and code blocks." },
      { heading: "Copy or download", text: "Copy the Markdown source straight into a README or issue, or download it as a .md file." },
      { heading: "Check GFM details", text: "Task lists need `- [x]` syntax and tables need a header separator row; if something does not render, that is usually why." },
    ],
    useCases: [
      { title: "Writing a README", text: "Draft documentation with a preview that matches how GitHub will actually render it, tables and task lists included." },
      { title: "Preparing a pull request description", text: "Get the formatting right before submitting, instead of editing and refreshing the rendered view on the host." },
      { title: "Drafting release notes", text: "Write structured notes with headings and bullets, then paste the source wherever your changelog lives." },
    ],
    faq: [
      { q: "What is the difference between Markdown and GFM?", a: "GitHub Flavored Markdown is a superset that adds tables, task lists, strikethrough and autolinked URLs. Plain Markdown ignores all of those. This editor implements GFM, which is what GitHub, most wikis and most static site generators accept." },
      { q: "Why is my table not rendering?", a: "A GFM table needs a header row, then a separator row of dashes, then the body rows — and all three need matching pipe characters. A missing separator row is the usual cause." },
      { q: "Does it support footnotes or math?", a: "Not by default. Footnotes and LaTeX are extensions beyond GFM and are not part of the CommonMark or GFM specifications, so portability suffers when you use them." },
      { q: "Is my document saved or uploaded?", a: "Neither. The editor keeps the text in the page only, so a refresh loses it and nothing is sent to a server. Download the .md file if you want to keep a copy." },
      { q: "Can I use it offline?", a: "Once the page and its editor component have loaded, yes — there is no round trip per keystroke, because the preview is rendered locally." },
      { q: "Will the output look the same everywhere?", a: "For the GFM subset, essentially yes. Different renderers style headings and code blocks differently, but the structure — headings, lists, tables, code — is stable, which is the point of writing in Markdown." },
    ],
    relatedTools: ["html-formatter", "text-formatter", "case-converter", "mermaid"],
  },
  ...
  "image-compress": {
    ...
    icon: "🗜️",
    category: CATEGORIES.image,
    seoTitle: "Image Compressor Free — Compress JPG/PNG/WebP Online",
    seoDesc: "Free image compressor online. Compress JPG, PNG, WebP, AVIF with quality control. Reduce image file size without losing quality. 100% browser-based, no signup.",
    seoKeywords: [
        ...
        "webp compression free",
        "image optimization tool",
        "compress image for web",
        "free image compressor no signup",
        "image compressor browser based",
        "reduce photo file size online",
        ...
        "jpg quality reducer online",
        "png file size reducer free"
      ],
  ...
  "ai-watermark-remover": {
    ...
    desc: "Remove Gemini AI image watermarks in browser",
    icon: "🧹",
    category: CATEGORIES.image,
    stars: 4,
    ...
    seoKeywords: [
      ...
      "remove Gemini star logo",
      "Gemini image watermark eraser",
      "Gemini AI logo remover free",
      "remove Gemini watermark online no signup",
      "Gemini watermark removal tool free",
      "how to remove Gemini AI watermark",
      "Gemini generated image watermark remover",
      // Doubao / Jimeng
      "remove Doubao watermark free",
      "Doubao AI watermark remover online",
      "remove Jimeng watermark",
      "Jimeng AI watermark remover free",
      "Doubao image watermark eraser",
      "Jimeng watermark removal tool",
      "remove ByteDance AI watermark",
      // Tongyi / Wenxin
      "remove Tongyi watermark free",
      "Tongyi AI watermark remover online",
      "remove Wenxin watermark",
      "Wenxin AI watermark remover free",
      "Tongyi image watermark eraser",
      "Wenxin watermark removal tool",
      "remove Alibaba AI watermark",
      "remove Baidu AI watermark",
      // Generic AI watermark
      "remove AI image watermark free",
      "AI image watermark remover online",
      "AI generated image watermark removal",
      "remove watermark from AI image free",
      "AI watermark eraser free no signup",
      "free AI watermark remover browser based",
      "remove AI watermark from image online",
      "AI image watermark removal tool free",
      "how to remove AI image watermark",
      "best free AI watermark remover",
      // Leonardo / others
      "remove Leonardo AI watermark",
      "Leonardo AI watermark remover free",
      "remove AI art watermark free",
      // Use case long-tail
      "clean AI generated image for presentation",
      "remove AI watermark before printing",
      "AI image watermark remover no blur",
      "lossless AI watermark removal free",
      "remove AI watermark without losing quality",
      // Language / region
      "AI watermark remover free online tool",
      "free online AI watermark eraser no registration",
      "browser based AI watermark remover free",
    ],
    description: "Remove visible watermarks from Gemini AI-generated images. Uses mathematically precise reverse alpha blending for lossless removal. Works entirely in your browser — no images are uploaded to any server. Supports JPG, PNG, WebP formats.",
    howToUse: [
      { heading: "Upload a Gemini image", text: "Drag and drop a Gemini-generated image (with the visible star watermark in the bottom-right corner) or click to browse." },
      { heading: "Auto-detect & remove", text: "The tool automatically detects the watermark position and size, then applies reverse alpha blending to restore the original pixels." },
      { heading: "Preview & download", text: "Compare before/after in the preview. Download the cleaned image in PNG or JPG format." },
    ],
    useCases: [
    ...
    faq: [
      { q: "What watermarks can this tool remove?", a: "This tool specifically removes the visible Gemini AI star watermark (bottom-right corner). It does not remove invisible watermarks like SynthID, or watermarks from other AI tools (DALL-E, Midjourney, etc.)." },
      { q: "Is the removal lossless?", a: "Yes. The tool uses reverse alpha blending — the mathematical inverse of how Gemini adds the watermark. When the watermark alpha map is accurately reconstructed, the original pixel values are recovered exactly." },
      { q: "Is this legal?", a: "Removing watermarks may violate Google's Terms of Service. This tool is provided for educational and personal use only. Do not use removed-watermark images for commercial purposes without permission." },
    ...
    relatedTools: ["image-compress", "image-convert", "image-strip-metadata"],
  },

  "media-downloader": {
    title: "Media Downloader",
    desc: "Download videos from Bilibili, Douyin, TikTok, Instagram",
    icon: "📥",
    category: CATEGORIES.image,
    stars: 4,
    ...
    seoKeywords: [
      ...
      "no registration video download",
      "download video without account",
      // Chinese keywords
      "哔哩哔哩下载",
      "抖音视频下载",
      "小红书下载",
    ...
    description: "Free online media downloader supporting 20+ platforms including Bilibili, Douyin, TikTok, Instagram, Xiaohongshu, WeChat, Weibo, X (Twitter), YouTube, and more. Paste the link, parse, and download video, audio, or images. No signup required.",
    howToUse: [
      { heading: "Copy the video link", text: "Copy the video link from Bilibili, Douyin, TikTok, Instagram, or any supported platform." },
      { heading: "Paste and parse", text: "Paste the link into the input box and click Parse. The tool will automatically detect the platform." },
      { heading: "Download", text: "Choose to download video, audio, or images. Click the download button to save to your device." },
    ],
    useCases: [
      { title: "Save videos offline", text: "Download videos from social media platforms to watch offline without internet connection." },
      { title: "Extract audio content", text: "Extract audio from music videos, podcasts, or voice content for audio-only playback." },
      { title: "Download image posts", text: "Save image collections from Instagram, Xiaohongshu, and other visual platforms." },
    ],
    faq: [
      { q: "Is this media downloader free?", a: "Yes, completely free. No signup, no registration, no payment required." },
      { q: "Do downloaded videos have watermarks?", a: "We attempt to download without platform watermarks where possible. Availability depends on the source platform." },
      { q: "What platforms are supported?", a: "20+ platforms including Bilibili, Douyin, TikTok, Instagram, Xiaohongshu, WeChat, Weibo, X (Twitter), YouTube, Pinterest, Reddit, Twitch, Vimeo, and more." },
      { q: "Can I download private or restricted content?", a: "No. Our downloader only works with publicly accessible content." },
      { q: "Is downloading videos legal?", a: "Download for personal use is generally acceptable. Please respect copyright and intellectual property rights." },
    ],
    relatedTools: ["image-upscale", "image-compress", "ai-watermark-remover"],
  },
  ...
  "image-convert": {
    ...
    howToUse: [
      ...
      { heading: "Set options", text: "For lossy formats (JPG, WebP) set the quality level. PNG output keeps transparency." },
      { heading: "Convert and download", text: "Click Convert, then download the results." },
    ],
    useCases: [
      { title: "Web migration", text: "Convert site images from PNG to WebP for better compression and faster loading." },
      { title: "Print preparation", text: "Convert WebP images, which some print workflows don't accept, into high-quality JPG." },
  ...
  "handwriting-animation": {
    ...
    faq: [
      ...
      { q: "Can I download the animation as a video?", a: "Yes. Leave the export format on WebM and click Export — the animation is recorded straight from the canvas with the MediaRecorder API and downloaded as a .webm video file. (If you would rather have a GIF, switch the format selector to GIF before exporting.)" },
      ...
      { q: "Does it support Chinese, Japanese or Korean characters?", a: "Partly. Klee One animates Japanese kana plus first- and second-grade kanji. There is currently no Chinese or Korean font in the bundle, so Chinese and Korean text will not animate — the tool is honest about this rather than producing broken strokes." },
      { q: "Can I use my own font?", a: "Not yet — the tool ships with 8 built-in fonts: Caveat, Italianno, Tangerine, Parisienne, Suez One, Klee One, Amiri and Tillana. Each one carries its own stroke data, which is what makes the drawing animation possible." },
  ...
  "html-visual-editor": {
    ...
    icon: "🖊️",
    category: CATEGORIES.dev,
    seoTitle: "HTML Visual Editor Free — Online Tool",
  ...
  "discord-timestamp": {
    ...
    icon: "💬",
    category: CATEGORIES.utility,
    seoTitle: "Discord Timestamp Generator Free — Online Tool",
  ...
  "seconds-to-time": {
    ...
    icon: "⏱️",
    category: CATEGORIES.utility,
    seoTitle: "Seconds to Time Converter Free — Online Tool",
  ...
  "time-between-dates": {
    ...
    icon: "📅",
    category: CATEGORIES.utility,
    seoTitle: "Time Between Dates Calculator Free — Online Tool",
  ...
  "cron-parser": {
    ...
    icon: "⏰",
    category: CATEGORIES.dev,
    seoTitle: "Cron Expression Parser Free — Online Tool",
  ...
  "leap-year": {
    ...
    icon: "📆",
    category: CATEGORIES.utility,
    seoTitle: "Leap Year Checker Free — Online Tool",
  ...
  "shuffle-lines": {
    ...
    icon: "🔀",
    category: CATEGORIES.text,
    seoTitle: "Shuffle Lines Free — Online Text Tool",
  ...
  "sort-lines": {
    ...
    icon: "📝",
    category: CATEGORIES.text,
    seoTitle: "Sort Lines Free — Online Text Tool",
  ...
  "unique-lines": {
    ...
    icon: "🔍",
    category: CATEGORIES.text,
    seoTitle: "Find Unique Lines Free — Online Text Tool",
  ...
  "days-to-hours": {
    ...
    icon: "⏱️",
    category: CATEGORIES.utility,
    seoTitle: "Days to Hours Converter Free — Online Tool",
  ...
  "hours-to-days": {
    ...
    icon: "📅",
    category: CATEGORIES.utility,
    seoTitle: "Hours to Days Converter Free — Online Tool",
  ...
  "time-to-seconds": {
    ...
    icon: "⏲",
    category: CATEGORIES.utility,
    seoTitle: "Time to Seconds Converter Free — Online Tool",
  ...
  "truncate-time": {
    ...
    icon: "⏳",
    category: CATEGORIES.utility,
    seoTitle: "Truncate Clock Time Free — Online Tool",
  ...
  "time-to-decimal": {
    ...
    icon: "⏴",
    category: CATEGORIES.utility,
    seoTitle: "Time to Decimal Converter Free — Online Tool",
  ...
  "duplicate-lines": {
    ...
    icon: "📋",
    category: CATEGORIES.text,
    seoTitle: "Duplicate Lines Free — Online Text Tool",
  ...
  "find-popular": {
    ...
    icon: "📊",
    category: CATEGORIES.text,
    seoTitle: "Find Most Popular Items Free — Online Text Tool",
  ...
  "reverse-lines": {
    ...
    icon: "🔃",
    category: CATEGORIES.text,
    seoTitle: "Reverse Lines Free — Online Text Tool",
  ...
  "rotate-lines": {
    ...
    icon: "🔄",
    category: CATEGORIES.text,
    seoTitle: "Rotate Lines Free — Online Text Tool",
  ...
  "wrap-lines": {
    ...
    icon: "📝",
    category: CATEGORIES.text,
    seoTitle: "Wrap / Unwrap Lines Free — Online Text Tool",
  ...
  "xml-beautifier": {
    ...
    icon: "📄",
    category: CATEGORIES.utility,
    seoTitle: "XML Beautifier Free — Online Tool",
  ...
  "truncate-lines": {
    ...
    icon: "✂️",
    category: CATEGORIES.text,
    seoTitle: "Truncate Lines Free — Online Text Tool",
  ...
  "unwrap-lines": {
    ...
    icon: "📝",
    category: CATEGORIES.text,
    seoTitle: "Unwrap Lines Free — Online Text Tool",
  ...
  "csv-to-yaml": {
    ...
    icon: "📋",
    category: CATEGORIES.converter,
    seoTitle: "CSV to YAML Converter Free — Online Tool",
  ...
  "tsv-to-json": {
    ...
    icon: "📌",
    category: CATEGORIES.converter,
    seoTitle: "TSV to JSON Converter Free — Online Tool",
  ...
  "transpose-csv": {
    ...
    icon: "🔄",
    category: CATEGORIES.converter,
    seoTitle: "Transpose CSV Free — Online Tool",
  ...
  "sort-json": {
    ...
    icon: "🔃",
    category: CATEGORIES.dev,
    seoTitle: "Sort JSON Keys Free — Online Tool",
  ...
  "find-incomplete-csv": {
    ...
    icon: "🔍",
    category: CATEGORIES.dev,
    seoTitle: "Find Incomplete CSV Records Free — Online Tool",
  ...
  "insert-csv-column": {
    ...
    icon: "➕",
    category: CATEGORIES.dev,
    seoTitle: "Insert CSV Column Free — Online Tool",
  ...
  "swap-csv-columns": {
    ...
    icon: "🔄",
    category: CATEGORIES.dev,
    seoTitle: "Swap CSV Columns Free — Online Tool",
  ...
  "csv-rows-to-columns": {
    ...
    icon: "🔃",
    category: CATEGORIES.dev,
    seoTitle: "CSV Rows to Columns Free — Online Tool",
  ...
  "group-lines": {
    ...
    icon: "📊",
    category: CATEGORIES.dev,
    seoTitle: "Group Lines Free — Online Tool",
  ...
  "text-compare": {
    ...
    icon: "🔍",
    category: CATEGORIES.dev,
    seoTitle: "Text Compare Free — Online Tool",
  ...
  "arithmetic-sequence": {
    ...
    icon: "🔢",
    category: CATEGORIES.dev,
    seoTitle: "Arithmetic Sequence Generator Free — Online Tool",
  ...
  "text-replacer": {
    ...
    icon: "🔍",
    category: CATEGORIES.dev,
    seoTitle: "Text Replacer Free — Online Tool",
  ...
  "morse-code": {
    ...
    icon: "📡",
    category: CATEGORIES.dev,
    seoTitle: "Morse Code Converter Free — Online Tool",
  ...
  "extract-substring": {
    ...
    icon: "✂️",
    category: CATEGORIES.dev,
    seoTitle: "Extract Substring Free — Online Tool",
  ...
  "hidden-character-detector": {
    ...
    icon: "🔍",
    category: CATEGORIES.dev,
    seoTitle: "Hidden Character Detector Free — Online Tool",
  ...
  "check-leap-years": {
    ...
    seoTitle: "Check Leap Years Free — Online Tool",
  ...
  "convert-days-to-hours": {
    ...
    icon: "⏱️",
    category: CATEGORIES.time,
    seoTitle: "Convert Days to Hours Free — Online Tool",
  ...
  "convert-hours-to-days": {
    ...
    icon: "📅",
    category: CATEGORIES.time,
    seoTitle: "Convert Hours to Days Free — Online Tool",
  ...
  "convert-seconds-to-time": {
    ...
    icon: "⏰",
    category: CATEGORIES.time,
    seoTitle: "Convert Seconds to Time Free — Online Tool",
  ...
  "convert-time-to-seconds": {
    ...
    icon: "⚡",
    category: CATEGORIES.time,
    seoTitle: "Convert Time to Seconds Free — Online Tool",
  ...
  "convert-time-to-decimal": {
    ...
    icon: "🔢",
    category: CATEGORIES.time,
    seoTitle: "Convert Time to Decimal Free — Online Tool",
  ...
  "crontab-guru": {
    ...
    icon: "📋",
    category: CATEGORIES.time,
    seoTitle: "Crontab Guru Free — Online Tool",
    ...
    seoKeywords: [
        ...
        "crontab syntax explainer free",
        "cron schedule generator online",
        "explain cron expression online free",
        "crontab guru alternative free",
        "cron job time calculator online",
        "cron expression parser free online",
        "next run time cron calculator",
        "crontab format checker online free",
        "cron expression builder no signup"
      ],
  ...
  "list-reverse": {
    ...
    icon: "🔄",
    category: CATEGORIES.text,
    seoTitle: "Reverse Lines Free — Online Tool",
  ...
  "list-shuffle": {
    ...
    icon: "🎲",
    category: CATEGORIES.text,
    seoTitle: "Shuffle Lines Free — Online Tool",
  ...
  "list-sort": {
    ...
    icon: "📝",
    category: CATEGORIES.text,
    seoTitle: "Sort Lines Free — Online Tool",
  ...
  "list-duplicate": {
    ...
    icon: "📋",
    category: CATEGORIES.text,
    seoTitle: "Duplicate Lines Free — Online Tool",
  ...
  "list-unique": {
    ...
    icon: "✨",
    category: CATEGORIES.text,
    seoTitle: "Remove Duplicates Free — Online Tool",
  ...
  "list-wrap": {
    ...
    icon: "📄",
    category: CATEGORIES.text,
    seoTitle: "Wrap Text Free — Online Tool",
  ...
  "list-unwrap": {
    ...
    icon: "📎",
    category: CATEGORIES.text,
    seoTitle: "Unwrap Text Free — Online Tool",
  ...
  "list-truncate": {
    ...
    icon: "✂️",
    category: CATEGORIES.text,
    seoTitle: "Truncate Lines Free — Online Tool",
  ...
  "list-rotate": {
    ...
    icon: "🔃",
    category: CATEGORIES.text,
    seoTitle: "Rotate Lines Free — Online Tool",
  ...
  "string-uppercase": {
    ...
    icon: "🔠",
    category: CATEGORIES.text,
    seoTitle: "Uppercase Text Free — Online Tool",
  ...
  "string-truncate": {
    ...
    icon: "✂️",
    category: CATEGORIES.text,
    seoTitle: "Truncate Text Free — Online Tool",
  ...
  "string-palindrome": {
    ...
    icon: "🔤",
    category: CATEGORIES.text,
    seoTitle: "Check Palindrome Free — Online Tool",
  ...
  "pdf-tools": {
    ...
    badge: "New",
    category: CATEGORIES.converter,
    seoTitle: "PDF Tools Free — Online Tool",
  ...
  "curl-to-code": {
    ...
    desc: "Convert cURL commands to code",
    icon: "🖥️",
    category: CATEGORIES.dev,
    seoTitle: "cURL to Code Converter Free — Online Tool",
    seoDesc: "Free cURL to code converter online. Turn curl commands into JavaScript, Python, PHP or Go. 100% browser-based, no upload.",
    seoKeywords: ["curl to code online free", "curl to fetch online free", "curl to python requests free", "convert curl to code online", "curl converter no signup free", "free curl to code browser", "curl to axios online free", "curl command converter free"],
    description: "Convert a cURL command into ready-to-run code for JavaScript (fetch/axios), Python (requests), PHP (cURL), and Go (net/http).",
    howToUse: [
      { heading: "Paste a cURL command", text: "Paste the curl command you copied from your browser or terminal." },
      { heading: "Pick a language", text: "Choose fetch, axios, Python, PHP, or Go." },
      { heading: "Copy the code", text: "Click Convert, then copy the generated code." },
    ],
    useCases: [
      { title: "From browser DevTools", text: "Copy a request as cURL and turn it into code instantly." },
      { title: "API integration", text: "Reproduce an API call in your language of choice." },
      { title: "Learning", text: "See how the same request looks across languages." },
    ],
    faq: [
      { q: "Which cURL options are supported?", a: "The common ones: -X, -H, -d/--data, -u, -b, -A, and --url, including multiline commands." },
      { q: "Is my command uploaded?", a: "No. Parsing and code generation happen entirely in your browser, so any tokens in the command stay local." },
      { q: "Does it handle Basic auth?", a: "Yes. A -u user:pass pair is turned into an Authorization: Basic header." },
    ],
    relatedTools: ["http-status", "json-formatter", "user-agent"],
  },
  ...
  "gitignore-generator": {
    ...
    icon: "🚫",
    category: CATEGORIES.dev,
    seoTitle: "Gitignore Generator Free — Online Tool",
    seoDesc: "Free gitignore generator online. Build a .gitignore from templates for Node, Python, Java, macOS, IDE and more. No signup.",
    seoKeywords: ["gitignore generator online free", "generate gitignore file online", "gitignore template generator free", "node gitignore generator online", "python gitignore generator free", "gitignore no signup free", "free gitignore generator browser", "custom gitignore online free"],
    description: "Build a .gitignore by mixing ready-made templates (Node, Python, Java, Go, Rust, React/Next, macOS, Windows, Linux, IDE, Logs, Env/Secrets) plus your own custom entries, then copy or download.",
    howToUse: [
      { heading: "Select templates", text: "Click the language, OS, or IDE templates you need." },
      { heading: "Add custom rules", text: "Optionally add your own ignore patterns, one per line." },
      { heading: "Copy or download", text: "Copy the .gitignore or download it directly." },
    ],
    useCases: [
      { title: "New projects", text: "Get a sensible .gitignore without hunting for snippets." },
      { title: "Cross-platform teams", text: "Include macOS, Windows, and Linux noise in one file." },
      { title: "Secret safety", text: "Include .env patterns to avoid committing credentials." },
    ],
    faq: [
      { q: "Does it overwrite my existing .gitignore?", a: "No. It only generates text for you to copy or download; nothing is written to your repo." },
      { q: "Can I combine multiple templates?", a: "Yes. Select as many templates as you like — their rules are concatenated with comments." },
      { q: "Is the output uploaded?", a: "No. Everything is generated locally in your browser." },
    ],
    relatedTools: ["curl-to-code", "http-status", "regex"],
  },

  "http-status": {
    title: "HTTP Status Codes",
    desc: "Look up HTTP status codes",
    icon: "🌐",
    category: CATEGORIES.dev,
    seoTitle: "HTTP Status Codes List Free — Online Reference",
    seoDesc: "Free HTTP status codes reference online. Search 1xx-5xx codes with names and meanings. 100% browser-based, no signup.",
    seoKeywords: ["http status codes list online free", "http status code lookup free", "404 status code meaning free", "http status codes reference online", "http error codes list free", "status code checker online free", "http response codes free tool", "http status code search online"],
    description: "Search a reference of HTTP status codes (1xx-5xx) with their names and plain-English explanations.",
    howToUse: [
      { heading: "Search or browse", text: "Type a code, name, or meaning — or scroll the list." },
      { heading: "Read the meaning", text: "Each entry shows the code, its name, and what it means." },
    ],
    useCases: [
      { title: "Debugging APIs", text: "Quickly understand an unexpected status code." },
      { title: "Writing docs", text: "Reference correct names for API responses." },
      { title: "Interviews", text: "Brush up on the 4xx/5xx families." },
    ],
    faq: [
      { q: "How many codes are listed?", a: "The most common codes across the 1xx-5xx families, with clear explanations." },
      { q: "Is this a live API?", a: "No. It is a static reference that runs entirely in your browser." },
      { q: "What does a 418 mean?", a: "It is an April Fools' joke code (RFC 2324), still listed here for completeness." },
    ],
    relatedTools: ["user-agent", "curl-to-code", "ip-calc"],
  },

  "unit-converter": {
    title: "Unit Converter",
    desc: "Convert length, mass, temperature and more",
    icon: "📏",
    category: CATEGORIES.converter,
    seoTitle: "Unit Converter Free — Online Tool",
    seoDesc: "Free unit converter online. Convert length, mass, temperature, area, volume, speed and data units. 100% browser-based.",
    seoKeywords: ["unit converter online free", "length converter online free", "temperature converter online free", "weight converter online free", "unit conversion no signup free", "free unit converter browser", "metric to imperial converter free", "online unit converter tool free"],
    description: "Convert between units of length, mass, temperature, area, volume, speed, and digital data with instant, precise results.",
    howToUse: [
      { heading: "Pick a category", text: "Choose length, mass, temperature, area, volume, speed, or data." },
      { heading: "Enter a value", text: "Type the value and choose the from/to units." },
      { heading: "Read the result", text: "The converted value appears instantly; swap units in one click." },
    ],
    useCases: [
      { title: "Cooking and travel", text: "Convert metric and imperial units on the fly." },
      { title: "Engineering", text: "Switch between SI and US customary units." },
      { title: "File sizes", text: "Convert between bytes, KB, MB, GB, and TB." },
    ],
    faq: [
      { q: "Does it handle temperature correctly?", a: "Yes. Temperature uses offset formulas (not simple multiplication), so °C, °F and K convert accurately." },
      { q: "Are data units decimal or binary?", a: "Data units use binary multiples (1 KB = 1024 B)." },
      { q: "Is anything uploaded?", a: "No. All conversion happens in your browser." },
    ],
    relatedTools: ["byte-converter", "radix-converter", "roman-numeral"],
  },

  "color-contrast": {
    title: "Color Contrast Checker",
    desc: "Check WCAG color contrast ratio",
    icon: "🎨",
    category: CATEGORIES.dev,
    seoTitle: "Color Contrast Checker Free — WCAG Online Tool",
    seoDesc: "Free color contrast checker online. Test text/background contrast against WCAG AA and AAA. 100% browser-based.",
    seoKeywords: ["color contrast checker online free", "wcag contrast checker free", "accessibility color contrast online", "check contrast ratio online free", "contrast ratio calculator free", "wcag aa checker online free", "color accessibility checker free", "text contrast checker online"],
    description: "Compute the WCAG contrast ratio between text and background colors and see whether they meet AA and AAA thresholds for normal and large text.",
    howToUse: [
      { heading: "Pick colors", text: "Set the text color and background color." },
      { heading: "Read the ratio", text: "See the contrast ratio and a live text preview." },
      { heading: "Check compliance", text: "See which WCAG AA/AAA criteria pass." },
    ],
    useCases: [
      { title: "Accessible design", text: "Make sure text stays readable for low-vision users." },
      { title: "Design QA", text: "Verify a palette before shipping a theme." },
      { title: "Dark mode", text: "Test foreground/background pairs in either theme." },
    ],
    faq: [
      ...
      { q: "How is the ratio computed?", a: "From the relative luminance of each color using the WCAG 2.x formula, with the lighter color on top." },
      { q: "Is my input uploaded?", a: "No. Calculation runs entirely in your browser." },
    ],
    relatedTools: ["color-picker", "image-color-palette", "gradient-generator"],
  },

  "percentage-calculator": {
    title: "Percentage Calculator",
    desc: "Calculate percentages and changes",
    icon: "％",
    category: CATEGORIES.utility,
    seoTitle: "Percentage Calculator Free — Online Tool",
    seoDesc: "Free percentage calculator online. Find X% of Y, percentage change, and increase/decrease. 100% browser-based.",
    seoKeywords: ["percentage calculator online free", "percent of calculator free", "percentage change calculator online", "percent increase calculator free", "what percent of calculator online", "percentage difference calculator free", "free percentage tool browser", "percent calculator no signup free"],
    description: "Calculate what X% of Y is, what percent X is of Y, percentage change between two values, and increase/decrease by a percentage.",
    howToUse: [
      { heading: "Choose a mode", text: "Pick the question you want to answer." },
      { heading: "Enter two values", text: "Fill in the two numbers." },
      { heading: "Read the result", text: "The answer and the formula appear instantly." },
    ],
    useCases: [
      { title: "Discounts", text: "Work out a sale price or the percentage off." },
      { title: "Finance", text: "Compute gains, losses, and percentage change." },
      { title: "Statistics", text: "Quickly find what share one number is of another." },
    ],
    faq: [
      { q: "How is percentage change calculated?", a: "As ((new − old) / |old|) × 100, so a drop from 200 to 150 reads as −25%." },
      { q: "Does it round results?", a: "No. Results are shown at full precision so you can round as needed." },
      { q: "Is anything sent to a server?", a: "No. All math runs locally in your browser." },
    ],
    relatedTools: ["unit-converter", "byte-converter", "sum"],
  },

  "gradient-generator": {
    title: "CSS Gradient Generator",
    desc: "Create CSS linear and radial gradients",
    icon: "🌈",
    category: CATEGORIES.dev,
    seoTitle: "CSS Gradient Generator Free — Online Tool",
    seoDesc: "Free CSS gradient generator online. Build linear and radial gradients visually and copy the CSS. 100% browser-based.",
    seoKeywords: ["css gradient generator online free", "linear gradient generator free", "radial gradient generator online", "css gradient maker no signup free", "free css gradient tool browser", "gradient css generator online free", "background gradient generator free", "css linear gradient maker online"],
    description: "Visually build CSS linear and radial gradients with custom color stops and angles, preview live, and copy the generated CSS.",
    howToUse: [
      { heading: "Pick a type", text: "Choose linear (with angle) or radial." },
      { heading: "Add color stops", text: "Set colors and positions; add or remove stops." },
      { heading: "Copy the CSS", text: "Grab the background declaration and paste it in." },
    ],
    useCases: [
      { title: "Hero backgrounds", text: "Create eye-catching section backgrounds." },
      { title: "Buttons", text: "Design gradient call-to-action styles." },
      { title: "Design systems", text: "Produce consistent gradient tokens." },
    ],
    faq: [
      { q: "What CSS does it output?", a: "A background declaration using linear-gradient(angle, ...) or radial-gradient(circle, ...)." },
      { q: "How many color stops can I use?", a: "At least two, and you can add as many more as you need." },
      { q: "Is this saved anywhere?", a: "No. The gradient is built locally and nothing is uploaded." },
    ],
    relatedTools: ["color-picker", "color-contrast", "svg-editor"],
  },
  ...
  "timezone-converter": {
    ...
    icon: "🌍",
    category: CATEGORIES.time,
    seoTitle: "Timezone Converter Free — Online Tool",
    seoDesc: "Free timezone converter online. Convert date and time between world timezones with DST. 100% browser-based.",
    seoKeywords: ["timezone converter online free", "time zone converter free", "convert time between timezones online", "utc to local time converter free", "world time converter online free", "timezone conversion no signup free", "time zone calculator online free", "free timezone converter browser"],
    description: "Convert a date and time from one IANA timezone to another, with correct daylight-saving handling and UTC offset labels.",
    howToUse: [
      { heading: "Enter a date/time", text: "Pick the local wall-clock date and time." },
      { heading: "Choose zones", text: "Select the source and target timezones." },
      { heading: "Read the result", text: "The converted time and UTC value appear instantly." },
    ],
    useCases: [
      { title: "Scheduling calls", text: "Find a meeting time that works across regions." },
      { title: "Travel", text: "See what time it will be at your destination." },
      { title: "Logs", text: "Translate timestamps between zones." },
    ],
    faq: [
      { q: "Does it account for daylight saving?", a: "Yes. It uses your browser's IANA timezone database, so DST transitions are handled correctly." },
      { q: "Which timezones are available?", a: "A curated list of common global timezones, including UTC and major cities." },
      { q: "Is my input uploaded?", a: "No. Conversion happens locally in your browser." },
    ],
    relatedTools: ["unix-to-date", "convert-unix-to-date", "time-between-dates"],
  },

  "fake-data-generator": {
    title: "Fake Data Generator",
    desc: "Generate mock person data",
    icon: "🧪",
    category: CATEGORIES.utility,
    seoTitle: "Fake Data Generator Free — Online Tool",
    seoDesc: "Free fake data generator online. Create mock names, emails, phones and addresses as JSON or CSV. 100% browser-based.",
    seoKeywords: ["fake data generator online free", "mock data generator free", "test data generator online free", "fake name generator online", "random user data generator free", "dummy data generator online free", "fake csv generator free", "test data no signup free"],
    description: "Generate realistic-looking mock records — name, email, phone, company, address, date — as JSON, CSV, or plain text for testing and demos.",
    howToUse: [
      { heading: "Set the row count", text: "Choose how many records to generate (1-500)." },
      { heading: "Pick a format", text: "Select JSON, CSV, or plain text." },
      { heading: "Copy or download", text: "Generate, then copy or download the output." },
    ],
    useCases: [
      { title: "UI mocks", text: "Populate tables and lists with realistic data." },
      { title: "Test fixtures", text: "Seed tests with varied sample records." },
      { title: "Demos", text: "Avoid using real personal data in screenshots." },
    ],
    faq: [
      { q: "Is the data real?", a: "No. Every record is randomly generated locally and does not correspond to real people." },
      { q: "Can I export as CSV?", a: "Yes. Choose the CSV format and download it directly." },
      { q: "Is anything uploaded?", a: "No. Generation runs entirely in your browser." },
    ],
    relatedTools: ["random-string", "lorem-ipsum", "password-generator"],
  },
  ...
  "hmac-generator": {
    ...
    seoDesc: "Free HMAC generator online. Compute HMAC-SHA1/256/384/512 in hex or Base64. 100% browser-based, nothing uploaded.",
    seoKeywords: ["hmac generator online free", "hmac sha256 generator free", "hmac sha1 online free", "compute hmac online free", "hmac signature generator free", "hmac sha512 online free", "free hmac tool browser", "hmac calculator online free"],
    description: "Compute HMAC (Hash-based Message Authentication Code) for a message and secret key using SHA-1/256/384/512, output as hex or Base64.",
    howToUse: [
      { heading: "Enter a message", text: "Type or paste the message to authenticate." },
      { heading: "Enter a secret key", text: "Provide the shared secret." },
      { heading: "Compute", text: "Pick the hash algorithm and compute the signature." },
    ],
    useCases: [
      { title: "API signing", text: "Produce HMAC signatures for webhook verification." },
      { title: "Verify integrity", text: "Reproduce a signature to confirm data integrity." },
      { title: "Debug auth", text: "Compare computed vs expected signatures." },
    ],
    faq: [
      { q: "Which algorithms are supported?", a: "HMAC-SHA1, HMAC-SHA256, HMAC-SHA384, and HMAC-SHA512." },
      { q: "Is my secret key safe?", a: "Yes. Computation uses the Web Crypto API in your browser; the key never leaves the page." },
      { q: "Can I get Base64 output?", a: "Yes. Both hex and Base64 encodings are shown." },
    ],
    relatedTools: ["hash", "jwt-generator", "base64"],
  },

  "jwt-generator": {
    title: "JWT Generator",
    desc: "Sign JSON Web Tokens (HS256/384/512)",
    icon: "🎫",
    category: CATEGORIES.encryption,
    seoTitle: "JWT Generator Free — Online Tool",
    seoDesc: "Free JWT generator online. Sign JSON Web Tokens with HS256/384/512 in your browser. No signup, nothing uploaded.",
    seoKeywords: ["jwt generator online free", "json web token generator free", "jwt hs256 generator online", "sign jwt online free", "jwt encoder online free", "create jwt token online free", "jwt signing tool no signup free", "free jwt generator browser"],
    description: "Build and sign a JSON Web Token from a custom header and payload using HMAC (HS256/384/512), entirely in your browser.",
    howToUse: [
      { heading: "Choose an algorithm", text: "Select HS256, HS384, or HS512." },
      { heading: "Edit the payload", text: "Enter the claims as JSON." },
      { heading: "Sign", text: "Enter the secret and generate the token." },
    ],
    useCases: [
      { title: "API testing", text: "Create tokens to test authenticated endpoints." },
      { title: "Local development", text: "Mock JWTs without a backend." },
      { title: "Learning JWTs", text: "See how header, payload, and signature fit together." },
    ],
    faq: [
      { q: "Which algorithms are supported?", a: "HMAC-based HS256, HS384, and HS512." },
      { q: "Is my secret uploaded?", a: "No. Signing happens in your browser via the Web Crypto API; the secret never leaves the page." },
      { q: "Should I use this in production?", a: "Use it for testing and development. Verify signatures server-side and never ship secrets in client code." },
    ],
    relatedTools: ["jwt", "hmac-generator", "base64"],
  },

  "otp-generator": {
    title: "OTP Generator (TOTP/HOTP)",
    desc: "Generate TOTP and HOTP codes",
    icon: "🔢",
    category: CATEGORIES.encryption,
    seoTitle: "TOTP Generator Free — Online OTP Tool",
    seoDesc: "Free TOTP/HOTP generator online. Compute RFC 6238 one-time codes from a Base32 secret locally. No signup, no upload.",
    seoKeywords: ["totp generator online free", "otp generator online free", "hotp generator free", "authenticator code generator online", "2fa code generator free", "totp calculator online free", "one time password generator free", "free totp tool browser"],
    description: "Compute TOTP (RFC 6238) and HOTP (RFC 4226) one-time passwords from a Base32 secret, with digits, period, and algorithm options.",
    howToUse: [
      { heading: "Enter the secret", text: "Paste the Base32 secret from your authenticator setup." },
      { heading: "Choose mode", text: "Use TOTP (time-based) or HOTP (counter-based)." },
      { heading: "Read the code", text: "The current one-time code updates automatically." },
    ],
    useCases: [
      { title: "Verify a secret", text: "Check a TOTP secret matches your authenticator app." },
      { title: "Develop 2FA", text: "Test TOTP/HOTP implementations against known secrets." },
      { title: "Recover access", text: "Recompute a code when your phone isn't handy (use with care)." },
    ],
    faq: [
      { q: "Which algorithms are supported?", a: "SHA-1 (standard for TOTP), SHA-256, and SHA-512." },
      { q: "Is my secret uploaded?", a: "No. Codes are computed locally with the Web Crypto API; the secret never leaves your browser." },
      { q: "Why does my code differ from my app?", a: "Check that the secret, digits, period, and algorithm match your app's setup." },
    ],
    relatedTools: ["hmac-generator", "jwt-generator", "qrcode"],
  },

  "placeholder-generator": {
    title: "Placeholder Image Generator",
    desc: "Generate placeholder images as SVG/PNG",
    icon: "🖼️",
    category: CATEGORIES.utility,
    seoTitle: "Placeholder Image Generator Free — Online Tool",
    seoDesc: "Free placeholder image generator online. Create custom-size SVG and PNG placeholders with text. 100% browser-based.",
    seoKeywords: ["placeholder image generator online free", "placeholder image maker free", "dummy image generator online", "svg placeholder generator free", "placeholder png generator online", "custom placeholder image free", "mockup image generator online free", "free placeholder image tool"],
    description: "Generate placeholder images at any size with custom background color, text color, and label — preview, then download as SVG or PNG.",
    howToUse: [
      { heading: "Set dimensions", text: "Enter the width and height in pixels." },
      { heading: "Style it", text: "Choose background and text colors and an optional label." },
      { heading: "Download", text: "Preview live, then download as SVG or PNG." },
    ],
    useCases: [
      { title: "Layout mockups", text: "Fill image slots while designing a page." },
      { title: "Demos", text: "Add neutral images to prototypes and screenshots." },
      { title: "Design specs", text: "Produce size-labeled blocks for handoff." },
    ],
    faq: [
      { q: "What formats can I download?", a: "Both SVG (vector) and PNG (raster, rendered at your chosen size)." },
      { q: "Can I use my own text?", a: "Yes. Enter any label; leave it empty to show the dimensions instead." },
      { q: "Is anything uploaded?", a: "No. Images are generated locally in your browser." },
    ],
    relatedTools: ["qrcode", "svg-editor", "image-favicon"],
  },

  "qr-scanner": {
    title: "QR Code Scanner",
    desc: "Scan QR codes from camera or image",
    icon: "📷",
    category: CATEGORIES.utility,
    seoTitle: "QR Code Scanner Free — Online Tool",
    seoDesc: "Free QR code scanner online. Scan QR codes with your camera or from an image, locally in your browser. No upload.",
    seoKeywords: ["qr code scanner online free", "scan qr code online free", "qr reader online free", "scan qr code from image free", "qr code reader no signup free", "online qr scanner browser", "free qr code scanner tool", "qr code decode online free"],
    description: "Scan QR codes using your device camera or by uploading an image. Decoding runs in the browser with the native BarcodeDetector API — no image is uploaded.",
    howToUse: [
      { heading: "Allow camera or upload", text: "Start the camera, or upload an image containing a QR code." },
      { heading: "Detect", text: "Point at the code; results appear as they are found." },
      { heading: "Copy the value", text: "Copy the decoded text or URL." },
    ],
    useCases: [
      { title: "Quick scans", text: "Read a QR code without installing an app." },
      { title: "From screenshots", text: "Decode a QR code in an image you already have." },
      { title: "Privacy", text: "Decode locally instead of sending the image to a service." },
    ],
    faq: [
      { q: "Which browsers are supported?", a: "Chrome and Edge (desktop and Android) expose the native BarcodeDetector API. The tool shows a clear notice on browsers that don't." },
      { q: "Is my camera feed uploaded?", a: "No. Detection runs locally in your browser; no frames or images are sent anywhere." },
      { q: "Can it read from a saved image?", a: "Yes. Upload a screenshot or photo containing a QR code to decode it." },
    ],
    relatedTools: ["qrcode", "barcode", "image-info"],
  },
};
