      ...
      <main className="flex-1">
        <div className="container mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-gray max-w-none dark:prose-invert space-y-6">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">4. Directory Content &amp; Third-Party Links</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground text-sm leading-relaxed space-y-2">
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">5. Intellectual Property</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground text-sm leading-relaxed space-y-2">
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">6. Disclaimer of Warranties</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground text-sm leading-relaxed space-y-2">
                <p>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="text-lg">8. Advertising &amp; Sponsored Content</CardTitle>
              </CardHeader>
              <CardContent className="text-muted-foreground text-sm leading-relaxed space-y-2">
                <p>
